...
Concretely this is :mod:`amsc.chunking.structural` with **exactly one rule
...
:func:`amsc.chunking.structural.chunk_units` on the frozen corpus. That is what
...
from .structural import RENDER_SEPARATOR, Piece, Section, _render, _sections
