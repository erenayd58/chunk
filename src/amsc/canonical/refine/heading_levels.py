...
:class:`~amsc.canonical.adapter.SectionHierarchyBuilder` at the same level --
...
:mod:`amsc.canonical.refine.numbered_headings` already uses -- a digit run closed by its own
...
**key** (:class:`~amsc.document.models.SemanticRole.GROUP`) partitions the section it
...
from ...document.models import SemanticRole
