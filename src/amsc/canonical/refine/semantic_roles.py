...
from ...document.models import ROLE_OPENS_SECTION, SemanticRole, UnitType
...
#: :mod:`amsc.canonical.refine.heading_levels` uses, so the two agree on what "numbered" means.
...
#: Same threshold, and the same signal, as :mod:`amsc.canonical.refine.running_headers`.
