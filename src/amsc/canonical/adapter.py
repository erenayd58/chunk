...
from ..document.io import sha256_file, validate_document_units
from ..document.models import RawDocumentUnit, SemanticRole, SourceSpan, UnitType
from .grid import (
    BBox,
    PictureGeometry,
    VisualTextLine,
...
class AtomicBlock:
    ...
    # the semantic-role pass ran; see :mod:`amsc.canonical.refine.semantic_roles`.
