...
from .refine.heading_levels import assign_heading_levels
from ..document.io import sha256_file
from .refine.lead_in_headings import demote_lead_ins
from ..document.models import RawDocumentUnit
from .refine.numbered_headings import promote_numbered_headings
from .refine.running_headers import drop_running_headers
from .refine.semantic_roles import assign_semantic_roles
from .refine.sentence_headings import demote_sentence_headings
from .refine.split_headings import rejoin_hyphenated_headings, rejoin_split_headings
from .refine.table_captions import demote_table_captions
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m amsc.canonical.prepare",
        description=(
