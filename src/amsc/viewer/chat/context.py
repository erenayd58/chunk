...
expansion is :func:`amsc.chunking.relations.expand_context` -- it walks only
...
from ...chunking.relations import derive_continuations, expand_context
from .index import IndexedChunk
from ...retrieval.pipeline import RetrievalHit
from ...tables.view import CONTEXT_HEADER
