...
The frozen three-arm benchmark (`amsc.research.benchmark.chunkers`, its configs and the
...
The four load-bearing reuse conditions from ``research.benchmark.chunkers`` apply
    ...
    *,
    ...
    if mapping.as_dict() != stored_mapping:
        raise ValueError(
            ...
            "re-run amsc.research.agentic.chunker before benchmarking"
        )
