...
The splitting walk is ``chunking.structural.chunk_units`` step for step -- the
...
:func:`amsc.chunking.structural.chunk_units`; a test pins that, which is what
...
is hardcoded -- :class:`amsc.providers.OpenAICompatibleJudgeProvider`,
...
baseline in :mod:`amsc.chunking.hybrid` / :mod:`amsc.research.semantic_assist`.
"""
...
from ...providers import BoundaryJudgeModel
...
def chunk_units_with_judge(
    ...
    *,
    ...
    The splitting walk reproduces ``chunking.structural.chunk_units`` exactly
    ...
    # chunking.structural.chunk_units.
