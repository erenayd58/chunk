...
from ..chunking.adaptive.config import V3Config, V4Config
from ..embedding.boundary import SemanticFragmentPooler
...
from ..chunking.adaptive.merge import SemanticSafeMergeResolver, V4ChunkDraft
from ..document.models import BoundaryEvidence, ChunkBoundary, ContentUnit, RawDocumentUnit
from .scale_calibration import (
    PerScaleAdaptiveCalibrator,
    ScaleCalibratedIntervalBoundarySelector,
    ScaleCalibrationProvenance,
)
from ..chunking.adaptive.selection import V2TailResolver
from ..chunking.adaptive.strength import DualBoundaryStrengthAnnotator
from ..document.tokenization import TiktokenTokenCounter, TokenCounter
from ..chunking.adaptive.units import HeadingAttachmentBuilder, RenderedTokenBudgeter, render_units
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="python -m amsc.research.v5")
