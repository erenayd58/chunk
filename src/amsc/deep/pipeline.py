...
Everything :mod:`amsc.deep.run` used to do between "load the units" and
...
1. **Standard** -- the frozen structure-first walk (``chunking.structural``).
...
from . import proposer as dp
from . import verifier as dv
from ..tables import search_text as table_search_text
from ..tables import view as table_view
