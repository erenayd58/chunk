...
from amsc.canonical.layout import (
    CheckpointLayoutProfile,
    ExplicitLogicalPageColumnOrderer,
    LayoutBox,
    load_checkpoint_layout_profile,
)
from amsc.research.corpus.qa import build_qa_summary, render_qa_preview
...
def test_checked_in_kkb_profile_is_explicit_and_strict(tmp_path: Path) -> None:
    profile_path = Path(__file__).parents[3] / "configs/checkpoint-kkb-2024.yaml"
