...
from amsc.chunking.adaptive.config import SelectionConfig, SemanticConfig, TokenLimitsConfig
from amsc.chunking.adaptive.features import AdjacentSemanticFeatureExtractor
...
from amsc.chunking.adaptive.selection import IntervalBoundarySelector, V1TailResolver, V2TailResolver
from amsc.chunking.adaptive.units import RenderedTokenBudgeter
...
def test_tail_resolver_removes_only_nonsemantic_fallback() -> None:
    ...
    from amsc.document.models import ChunkBoundary, SelectedSegment
