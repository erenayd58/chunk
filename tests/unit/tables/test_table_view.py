...
from amsc.deep.pipeline import MODE_DEEP, MODE_STANDARD, DeepAnalysisSettings, chunk_document
from amsc.document.models import RawDocumentUnit
from amsc.tables.view import enrich_rows, table_view_for, view_lines
...
def test_the_indexed_chunk_carries_the_reading_but_never_indexes_it():
    ...
    from amsc.viewer.chat.index import IndexedChunk
...
def _block(**kwargs):
    from amsc.viewer.chat.context import ContextBlock
...
def test_the_viewer_context_renders_the_reading_beneath_the_raw_table():
    from amsc.viewer.chat.context import AssembledContext
...
def test_the_context_budget_pays_for_the_reading():
    ...
    from amsc.viewer.chat.context import _context_tokens
    from amsc.viewer.chat.index import IndexedChunk
